        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-minus"></i> Tutup</button>
                    <button type="button" class="btn btn-success" onclick="store_data()"><i class="fa fa-plus"></i> Simpan</button>
                    <button type="button" hidden id="delete-data" class="btn btn-danger" onclick="delete_data()"><i class="fa fa-trash"></i> Delete</button>
                </div>
            </div>
        </div>
    </div>
